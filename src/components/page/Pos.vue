                ...
                <el-col :span="7" class="pos-order" id="order-list">
                    <el-tabs>
                        ...
                        <el-tab-pane label="挂单">
                            <el-table :data="table1Data" border style="width: 100%">
                                <el-table-column prop="goodsName" label="商品"></el-table-column>
                                <el-table-column prop="count" label="数量" width="50"></el-table-column>
                                <el-table-column prop="price" label="金额" width="60"></el-table-column>
                                <el-table-column label="操作" width="100" fixed="right">
                ...
                <el-col :span="17">
                    <div class="often-goods">
                        ...
                        <div class="often-goods-list">
                            <ul>
                                <li v-for="goods in oftenGoods" v-bind:key="goods.goodsId">
...
<!--                                        </div>-->
                            ...
                            <el-tab-pane label="小食">
                                <ul class="cookList">
                                    <li v-for="goods in type1Goods" v-bind:key="goods.goodsId">
                                        <!--<div class="foodImg-left">-->
                                        <span class="foodImg">
                                                <img :src="goods.goodsImg" alt="" width="100%">
                                             </span>
                            ...
                            <el-tab-pane label="饮料">
                                <ul class="cookList">
                                    <li v-for="goods in type2Goods" v-bind:key="goods.goodsId">
                                        <!--<div class="foodImg-left">-->
                                        <span class="foodImg">
                                                <img :src="goods.goodsImg" alt="" width="100%">
                                             </span>
                            ...
                            <el-tab-pane label="套餐">
                                <ul class="cookList">
                                    <li v-for="goods in type3Goods" v-bind:key="goods.goodsId">
                                        <!--<div class="foodImg-left">-->
                                        <span class="foodImg">
                                                <img :src="goods.goodsImg" alt="" width="100%">
                                             </span>
